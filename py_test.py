...
class Spider(Spider):  # 元类 默认的元类 type
	...
	def custom_getBaidu(self,cataloguePath):
		...
		# c='Hm_ck_1666748182159=;Hm_lpvt_e6c5e9705447b840241ebab6dbdb5fda=1666748182;Hm_lvt_e6c5e9705447b840241ebab6dbdb5fda=1666748182;BDUSS_BFESS=ZJWEpXVklNTG1zRHZZSFRJYWNMV0xYS3FVcFRtZWlmLURrdTBETUU1a2NISUJqRVFBQUFBJCQAAAAAAAAAAAEAAABWia5QyrnTw9XfODM0AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAByPWGMcj1hjV0;BDUSS=ZJWEpXVklNTG1zRHZZSFRJYWNMV0xYS3FVcFRtZWlmLURrdTBETUU1a2NISUJqRVFBQUFBJCQAAAAAAAAAAAEAAABWia5QyrnTw9XfODM0AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAByPWGMcj1hjV0;BAIDUID_BFESS=6BF7BAF1F818719EEEE935E40E12C7F8:FG=1;BAIDUID=6BF7BAF1F818719EEEE935E40E12C7F8:FG=1;newlogin=1;csrfToken=vFcdS_AN_Equiamtb24qxVYd;'
		...
		for vod in listCollection:
			...
			# print('名称:{0},尺寸:{1},类型:{2},路径:{3}'.format(name,remark,tag,aid))
			videos.append({
		        "vod_id":  aid,
		        "vod_name": name,
		        "vod_pic": img,
